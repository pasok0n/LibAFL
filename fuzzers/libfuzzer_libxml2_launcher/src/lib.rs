...
#[derive(Debug, Parser)]
#[command(
    name = "libfuzzer_libxml2_launcher",
    about = "A libfuzzer-like fuzzer for libxml2 with llmp-multithreading support and a launcher",
...
struct Opt {
    ...
    #[arg(short, long, help = "Set an initial corpus directory", name = "INPUT", default_value = "./corpus")]
    input: Vec<PathBuf>,
